...
parser.add_argument("--dp_eps", type=float, default=0.0)
parser.add_argument("--dp_delta", type=float, default=1e-5)
# hcfl+ clustering-statistics dp
parser.add_argument("--hcfl_dp_stats", type=bool, default=False)
parser.add_argument("--hcfl_proto_clip", type=float, default=0.0)
parser.add_argument("--hcfl_proto_noise", type=float, default=0.0)
parser.add_argument("--hcfl_count_clip", type=float, default=0.0)
parser.add_argument("--hcfl_count_noise", type=float, default=0.0)
parser.add_argument("--hcfl_dp_membership", type=bool, default=False)
parser.add_argument("--hcfl_membership_clip", type=float, default=0.0)
parser.add_argument("--hcfl_membership_noise", type=float, default=0.0)
parser.add_argument("--hcfl_entropy_reg", type=float, default=0.0)
parser.add_argument("--hcfl_dp_sample_weights", type=bool, default=False)
parser.add_argument("--hcfl_sample_clip", type=float, default=0.0)
parser.add_argument("--hcfl_sample_noise", type=float, default=0.0)
parser.add_argument("--hcfl_dp_accounting", type=bool, default=False)
parser.add_argument("--secure_agg_stats", type=bool, default=False)
parser.add_argument("--secure_agg_mask_scale", type=float, default=1.0)
